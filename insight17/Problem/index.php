...
<head>
    ...
    <title>DeCoders - Registrations closed !!</title>
    ...
    <?php include('../../commonResources/navigation.inc.php');?>
			...
			<div class="main-content">
				<div class="container">
					...
					<center><img src="../commonResources/img/title.jpg" style="width:50%"><h2 class="h2-responsive">Registrations for inSight17 has been closed.</h2></center>
        </div>
			</div>
